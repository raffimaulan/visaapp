/* ================================================================
   Applications Index — Filter, Dropdown & Bulk Delete
   ================================================================ */
...
(function () {
  ...
  $(document).ready(function () {
    var table = $('#table-applications').DataTable({
    ...
    function getChecked() {
      return document.querySelectorAll('#table-applications tbody .row-cb:checked');
    }
    ...
    function updateToolbar() {
      ...
      var total = document.querySelectorAll('#table-applications tbody .row-cb').length;
    ...
    $('#table-applications tbody').on('change', '.row-cb', function () {
    ...
    document.getElementById('btnBulkCancel').addEventListener('click', function () {
      document.querySelectorAll('#table-applications .row-cb').forEach(function (cb) {
        cb.checked = false;
